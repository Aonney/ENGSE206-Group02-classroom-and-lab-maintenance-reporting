...
|---|---|---|---|
| CU-01 | ยังไม่มีหลักฐานเพียงพอในการกำหนดเกณฑ์การจัดลำดับความเร่งด่วน (Priority) ของงานซ่อม | E-04 | งานประเภทใดควรจัดเป็น Urgent และใครเป็นผู้กำหนดระดับความเร่งด่วน |

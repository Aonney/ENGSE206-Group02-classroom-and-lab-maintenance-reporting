...
> **Version:** v0.2 (เพิ่ม Q-09–Q-11 เพื่อให้ครบเกณฑ์ 10–12 ข้อ และปิด gap เรื่อง Access Control / Photo Privacy)
...
| Q-03 | **[Technician]** ข้อมูลใดที่จำเป็นสำหรับการแจ้งซ่อม เพื่อให้สามารถดำเนินการได้ทันที? | Open | ค้นหาข้อมูลที่จำเป็นต่อการปฏิบัติงาน | EO-03 | รายการข้อมูลที่ใช้จริง เช่น สถานที่ อาการเสีย รูปภาพ รหัสครุภัณฑ์ |
| Q-04 | **[Technician / Manager]** งานลักษณะใดควรจัดเป็นงานเร่งด่วน (Urgent) และใช้เกณฑ์ใดในการจัดลำดับความสำคัญ? | Open + Probe | ศึกษาเกณฑ์ Priority และการจัดลำดับงาน | OQ-01 | เกณฑ์การจัดลำดับ ตัวอย่างงานเร่งด่วน และเหตุผล |
...
| Q-07 | **[Manager]** ปัจจุบันติดตามภาพรวมของงานซ่อมและประเมินผลการดำเนินงานอย่างไร? | Open | ศึกษาความต้องการของผู้ดูแลอาคาร/ผู้บริหาร | OQ-05 | รายงาน ตัวชี้วัด และข้อมูลที่ใช้ในการตัดสินใจ |
| Q-08 | **[Manager]** ข้อมูลหรือสถิติใดที่ช่วยให้วางแผนและปรับปรุงการบำรุงรักษาได้ดีขึ้น? | Probe | ศึกษาความต้องการด้านรายงานและข้อมูลประกอบการตัดสินใจ | OQ-05 | KPI รายงาน และข้อมูลที่ใช้จริง |
| Q-09 | **[Manager / Technician]** ตามบทบาทของแต่ละคน (นักศึกษา อาจารย์ เจ้าหน้าที่ ผู้ดูแลอาคาร) แต่ละกลุ่มควรเห็นหรือแก้ไขข้อมูลส่วนใดได้บ้าง และมีข้อมูลใดที่ไม่ควรให้เห็น? | Open | ศึกษาความต้องการด้านการควบคุมสิทธิ์การเข้าถึงข้อมูลตามบทบาท (Role-based Access) | OQ-07 | บทบาทผู้ใช้งาน สิทธิ์การเข้าถึง/แก้ไขข้อมูล และข้อมูลที่แต่ละบทบาทไม่ควรเห็น |
| Q-10 | **[Technician]** หากมีการแจ้งปัญหาห้อง/อุปกรณ์เดียวกันซ้ำ ควรถือว่าเป็นรายการซ้ำภายในระยะเวลาเท่าใด และมีเงื่อนไขอื่นประกอบหรือไม่? | Probe | ศึกษาเกณฑ์ Time Window และเงื่อนไขที่ใช้ตัดสินว่าเป็นรายการแจ้งซ้ำ เพื่อใช้ออกแบบ Merge/Alert Rule | OQ-03 | ช่วงเวลา (Time Window) และเงื่อนไขที่ถือว่าเป็นรายการซ้ำ |
| Q-11 | **[Student / Teacher]** เมื่อแนบรูปภาพประกอบการแจ้งซ่อม มีความกังวลเรื่องข้อมูลส่วนบุคคลที่อาจติดอยู่ในภาพหรือไม่ (เช่น ใบหน้า เอกสาร)? | Probe | ตรวจสอบความกังวลด้าน Privacy ของผู้ใช้งานเมื่อแนบรูปภาพ เพื่อยืนยันความจำเป็นของมาตรการปกปิดข้อมูลตาม Scope Statement | OQ-08 | ความคิดเห็นเกี่ยวกับความเป็นส่วนตัวของภาพที่แนบ และสิ่งที่ผู้ใช้กังวล |
| Q-12 | **[All]** ขอสรุปว่า... [กล่าวสรุปขั้นตอนหรือกฎที่ได้ยิน] ...ถูกต้องหรือไม่? มีส่วนใดที่ควรแก้ไขหรือเพิ่มเติม? | Validation | ยืนยันความเข้าใจและลด Recording Bias | ทุก OQ | ข้อมูลที่ได้รับการยืนยันหรือแก้ไข |
...
- สิทธิ์การเข้าถึงข้อมูลตามบทบาทผู้ใช้งาน (Role-based Access) — ยังไม่มี Evidence รองรับ NFR-CLMRS-01
- ความกังวลด้านความเป็นส่วนตัวของรูปภาพที่แนบประกอบการแจ้งซ่อม
...
| Q-06 | ผู้ตอบเริ่มเสนอช่องทางการแจ้งเตือนที่ต้องการ เช่น LINE Official Account, Email หรือระบบแจ้งเตือนของมหาวิทยาลัย | เสี่ยงต่อ Solution Bias หากบันทึกเป็น Requirement | เพิ่มคำถาม "ปัจจุบันมีปัญหาอะไรกับการติดตามสถานะ และเวลาใดที่ต้องการทราบข้อมูลมากที่สุด?" |
| Q-08 | ผู้ตอบเสนอว่าต้องการ Dashboard แต่ยังไม่ระบุว่าต้องการข้อมูลหรือสถิติใด | ยังไม่ทราบว่าข้อมูลใดจำเป็นต่อการตัดสินใจ | เพิ่มคำถาม "ข้อมูลหรือสถิติใดที่ใช้ในการตัดสินใจบ่อยที่สุด และต้องการดูบ่อยเพียงใด?" |
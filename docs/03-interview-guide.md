...
| Q-05 | **[Technician / Manager]** ใครควรเป็นผู้ยืนยันว่าการซ่อมเสร็จสิ้น และหากมีการแจ้งปัญหาซ้ำควรจัดการอย่างไร? | Exception | ศึกษา Workflow การปิดงานและการจัดการงานซ้ำ | OQ-02, OQ-03 | ขั้นตอนปิดงาน ผู้รับผิดชอบ และแนวทางจัดการงานซ้ำ |
...
| Q-08 | ผู้ตอบบอกว่าต้องการ Dashboard แต่ยังไม่ทราบรายละเอียด | ยังไม่ทราบข้อมูลที่จำเป็นต่อการตัดสินใจ | เพิ่มคำถามติดตาม "ข้อมูลหรือสถิติใดช่วยให้วางแผนและตัดสินใจได้ดีที่สุด?" |
```

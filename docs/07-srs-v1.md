...
| FR-CLMRS-03 | ระบบต้องสนับสนุนการจัดลำดับความสำคัญของงานซ่อมตามระดับความเร่งด่วนที่กำหนด | Must | จัดลำดับตามเกณฑ์ Urgent ที่ได้รับการยืนยัน (AC-05); เกณฑ์ Urgent รอยืนยัน — **Test** (หลังยืนยัน OQ-01) | RC-F-03 → E-04, N-02 → US-03 / UC-03 / AC-05 | Needs Follow-up (OQ-01) |

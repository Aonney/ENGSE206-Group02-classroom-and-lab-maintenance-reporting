...
|---|---|---|---|
| 1 | **ทุก Must มีสาย traceable ครบ** (Evidence → Need → RC → FR/NFR) | **[x] ผ่าน** [ ] ไม่ผ่าน | FR-CLMRS-01, FR-CLMRS-02, FR-CLMRS-04, NFR-CLMRS-01 (Must) มีสาย Traceability ครบ แต่ **RC-F-05 กับ RC-F-06 ถูกอ้างสลับความหมายกันระหว่าง `04-requirement-candidates.md` กับ `05-requirement-backlog.md`** — ใน candidates.md RC-F-05 = ปิดงาน (ไม่มี Evidence) และ RC-F-06 = แจ้งซ้ำ (E-04) แต่ backlog กลับให้ FR-CLMRS-05 (Source RC-F-05) เป็นเรื่องแจ้งซ้ำ (trace E-04→N-04) และ FR-CLMRS-06 (Source RC-F-06) เป็นเรื่องปิดงาน (trace OQ-02→N-02) ทำให้สายอ้างอิงของทั้งสองข้อชี้ผิดทาง |
| 2 | **Evidence citation ถูกต้องตรงกับ Evidence Log** | **[x] ผ่าน** [ ] ไม่ผ่าน | `05-open-questions-and-issues.md` OQ-01 อ้าง Related Evidence เป็น `E-04` แต่ E-04 ใน `04-evidence-log.md` คือเรื่องแจ้งปัญหาซ้ำ ไม่ใช่เรื่องความเร่งด่วน (Urgent มาจาก E-02) และ OQ-03 อ้างรหัส `CU-01` ซึ่งไม่ปรากฏใน Evidence Log ที่ใดเลย |

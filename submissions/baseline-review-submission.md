...
> ไฟล์นี้เป็นของกิจกรรม Requirement Baseline Review
...
> เลือก Requirement ที่เป็น **Must** มา 3 ข้อ
> และแนบ permalink แบบ line anchor
...
> โดยจะนำไปยืนยันและปรับปรุงต่อใน Week 06
...
> รายการเหล่านี้จะถูกนำไปถามหรือทำต่อใน Week 06
> โดยไม่ลบ Requirement ที่เกี่ยวข้องออกจาก Backlog โดยไม่มี Evidence รองรับ

- [ ] **OQ-01:** เกณฑ์ใดใช้กำหนดงาน Urgent และใครเป็นผู้กำหนด?
...
## 7. Priority / Baseline Summary

| Priority | จำนวน | Requirement |
|---|---:|---|
| **Must** | 5 | FR-CLMRS-01, FR-CLMRS-02, FR-CLMRS-03, FR-CLMRS-04, NFR-CLMRS-01 |
| **Should** | 4 | FR-CLMRS-05, FR-CLMRS-06, FR-CLMRS-07, FR-CLMRS-09 |
| **Could** | 1 | FR-CLMRS-08 |
| **Won't yet** | 0 | - |
| **Hold** | 0 | - |

> **หมายเหตุ:** ไม่มี Requirement ที่ถูกจัดเป็น `Won't yet`
> หรือ `Hold` ใน Baseline รอบนี้
> เนื่องจากยังไม่มี Requirement ที่เข้าหลักเกณฑ์สำหรับการตัดออกหรือหยุดทั้งหมด
> ส่วนประเด็นที่ยังไม่มีหลักฐานเพียงพอจะถูกเก็บเป็น `Needs Follow-up` หรือ `Issue / Unknown`

---

## 8. Final Submission Snapshot
